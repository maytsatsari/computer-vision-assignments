"""
     train.py
    Ζήτημα 2.3: Εκπαίδευση του 2-Layer Neural Net στο CIFAR-10
  """
import argparse
import numpy as np
...
def training_step(model, X_batch, y_batch, reg):
    ...
    reg_loss, reg_grads = l2_regularization(model.params, reg)
    ...
    for param in reg_grads:
        grads[param] += reg_grads[param]
    return loss, grads
